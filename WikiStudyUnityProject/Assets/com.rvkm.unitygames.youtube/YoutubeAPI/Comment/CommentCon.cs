...
namespace com.rvkm.unitygames.YouTube
{
    public class CommentCon : MonoBehaviour
    {
        ...
        public static CommentCon Init(GameObject youtubeControllerGameObject, string API_KEY)
        {
            var con = youtubeControllerGameObject.GetComponent<CommentCon>();
            if (con == null)
            {
                con = youtubeControllerGameObject.AddComponent<CommentCon>();
            }
            con.API_KEY = API_KEY;
            return con;
        }
